...
public class ModLanguageProvider extends AbstractLanguageProvider {
    ...
    public void addTranslations(TranslationBuilder builder) {
        ...
        builder.add(StrawStatueModelPartsScreen.REFRESH_SKIN_TRANSLATION_KEY,
                "No statue skin was found. Click to try again.");
        builder.add(ModRegistry.SLIM_ARMS_STYLE_OPTION.getTranslationKey(), "Slim Arms");
        builder.add(ModRegistry.SLIM_ARMS_STYLE_OPTION.getDescriptionKey(),
                "Makes the statue's arms a few pixels less wide, like Minecraft's Alex skin.");
        builder.add(ModRegistry.CROUCHING_STYLE_OPTION.getTranslationKey(), "Crouching");
        builder.add(ModRegistry.CROUCHING_STYLE_OPTION.getDescriptionKey(),
